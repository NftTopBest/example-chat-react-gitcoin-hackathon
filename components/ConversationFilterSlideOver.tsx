...
type ConversationFilterSlideOverProps = {
  open: boolean
  onClose: (value: boolean) => void
}

export default function ConversationFilterSlideOver({
  open,
  onClose,
}: ConversationFilterSlideOverProps) {
  ...
  const addItem = () => {
    ...
    // @ts-ignore
    const newItems: Array<ConditionItem> = [...conditionItems, newItem]
              ...
              case 'ETH':
                accessControlConditions.push({
                  ...
                  returnValueTest: {
                    comparator,
                    value: ethers.utils
                      .parseEther(item.number.toString())
                      .toString(),
                  },
                })
                break
